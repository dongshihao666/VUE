<template>
    <div class="body">
        <el-table :data="alldata" style="width: 100%" :row-class-name="tableRowClassName" @row-dblclick.self="clickfn" :show-header="false">
            <el-table-column type="expand">
                <template scope="props">
                    <el-table :data="props.row.twodata" style="width:100%" :row-class-name="tableRowClassName" @row-dblclick.self="clickfn" :show-header="false">
                        ...
                        <el-table-column label="操作" width="200">
                            <template scope="scope">
                                ...
                                <el-button size="small" type="danger" @click="handleDelete(scope.$index, scope.row,'two',props.row.onedata)">删除</el-button>
                            </template>
